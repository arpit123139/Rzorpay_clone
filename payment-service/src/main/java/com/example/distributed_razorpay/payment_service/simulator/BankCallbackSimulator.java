package com.example.distributed_razorpay.payment_service.simulator;


import com.example.distributed_razorpay.common_lib.enums.ChaosMode;
...
import static com.example.distributed_razorpay.common_lib.enums.ChaosMode.*;
...
public class BankCallbackSimulator {
    ...
    @SchedulerLock(name = "payment-service-bank-call-back-simulator",lockAtMostFor = "10s",lockAtLeastFor = "1s")
